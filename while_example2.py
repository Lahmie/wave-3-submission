...
start_num = int(input("enter a start number: " )) #provide some start number
end_num =int(input("enter a end number: " )) #provide some end number that you stop when you hit
count_by =int(input("enter a count number: " )) #provide some number to count by 
