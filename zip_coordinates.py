...
# it to the list points. Each string should be formatted as label: x, y, z. For example, the string for the first
...
for i in enumerate(points):
    points.append(dict(zip(labels,"{} {} {}".format(x_coord,y_coord,z_coord))))
    print(i)
